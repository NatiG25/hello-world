...
```sh
  git clone git@github.com:NatiG25/trial-reviews-project-1.git
  cd trail-reviews-project-1
```

### Deployment

You can deploy this project by clicking the **Go Live** on your VScode.
